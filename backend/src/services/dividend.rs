...
#[cfg(test)] #[rustfmt::skip] mod tests { use super::*; #[test] fn test_preview_csv_basic() { let preview = preview_csv(["入金日,商品,口座,銘柄コード,銘柄,受取通貨,単価[円/現地通貨],数量[株/口],配当・分配金合計（税引前）[円/現地通貨],税額合計[円/現地通貨],受取金額[円/現地通貨]", "\"2025/12/09\",\"国内株式\",\"特定・一般\",\"8591\",\"オリックス\",\"円\",\"93.76\",\"200\",\"18,752\",\"3,808\",\"14,944\"", "\"2025/12/10\",\"国内株式\",\"特定・一般\",\"8306\",\"三菱ＵＦＪフィナンシャル・グループ\",\"円\",\"50.00\",\"300\",\"15,000\",\"3,047\",\"11,953\""].join("\n").as_bytes()).unwrap(); assert_eq!((preview.total_rows, preview.valid_rows, preview.errors.is_empty(), preview.rows.len()), (2, 2, true, 2)); assert!(matches!(preview_csv(b""), Err(ApiError::ValidationError(_)))); let preview = preview_csv(["入金日,商品,口座,銘柄コード,銘柄,受取通貨,単価[円/現地通貨],数量[株/口],配当・分配金合計（税引前）[円/現地通貨],税額合計[円/現地通貨],受取金額[円/現地通貨]", "\"2025/12/09\",\"国内株式\",\"特定・一般\",\"\",\"K D D I\",\"円\",\"93.76\",\"200\",\"18752\",\"3808\",\"14944\""].join("\n").as_bytes()).unwrap(); assert_eq!((preview.valid_rows, preview.rows[0]["security_code"].as_str(), preview.rows[0]["security_name"].as_str()), (1, Some(""), Some("KDDI"))); for (header, row, expected_message) in [("入金日,商品,口座,銘柄コード,受取通貨,単価[円/現地通貨],数量[株/口],配当・分配金合計（税引前）[円/現地通貨],税額合計[円/現地通貨],受取金額[円/現地通貨]", "\"2025/12/09\",\"国内株式\",\"特定・一般\",\"8591\",\"円\",\"93.76\",\"200\",\"18,752\",\"3,808\",\"14,944\"", "銘柄"), ("入金日,商品,口座,銘柄コード,銘柄,受取通貨,単価[円/現地通貨],数量[株/口],配当・分配金合計（税引前）[円/現地通貨],税額合計[円/現地通貨],受取金額[円/現地通貨]", "\"2025/13/09\",\"国内株式\",\"特定・一般\",\"8591\",\"オリックス\",\"円\",\"93.76\",\"200\",\"18752\",\"3808\",\"14944\"", "入金日")] { let preview = preview_csv([header, row].join("\n").as_bytes()).unwrap(); assert_eq!((preview.total_rows, preview.valid_rows, matches!(preview.errors.as_slice(), [error] if error.message.contains(expected_message))), (1, 0, true)); } } }
