  ...
  return (
    ...
    >
      ...
      <svg
        ...
        aria-hidden="true"
        className="rounded p-0.5 text-gray-400 opacity-100 group-hover:text-gray-600 group-hover:opacity-100 group-focus-visible:opacity-100 sm:opacity-0 sm:group-hover:opacity-100"
      >
